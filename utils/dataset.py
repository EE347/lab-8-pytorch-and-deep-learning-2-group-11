...
class TeamMateDataset(Dataset):
    ...
    def __init__(self, n_images=50, train=True):
        ...
        subject_0 = os.listdir(f'/home/pi/ee347/lab-8-pytorch-and-deep-learning-2-group-11/data/{dataset_type}/0')
        subject_1 = os.listdir(f'/home/pi/ee347/lab-8-pytorch-and-deep-learning-2-group-11/data/{dataset_type}/1')
        ...
        for i, image_path in tqdm(enumerate(image_paths), desc="Loading Images", total=n_images * 2, leave=False):
            ...
            image = cv2.imread(f'/home/pi/ee347/lab-8-pytorch-and-deep-learning-2-group-11/data/{dataset_type}/{subject}/' + image_path)
